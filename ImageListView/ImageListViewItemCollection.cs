...
namespace INTUSOFT.ImageListView
{
    public partial class ImageListView
    {
        ...
        public class ImageListViewItemCollection : IList<ImageListViewItem>, ICollection, IList, IEnumerable
        {
            ...
            /// <param name="key">The key identifying the item.</param>
            /// <param name="text">Text of the item.</param>
            public void Add(string filename,string caption)
            {
                Add(new ImageListViewItem(filename,caption));
            }
            ...
            /// <param name="key">The key identifying the item.</param>
            /// <param name="text">Text of the item.</param>
            public void Add(string filename, string caption,string toolTip)
            {
                Add(new ImageListViewItem(filename, caption, toolTip));
            }
            ...
            public void AddRange(string[] filenames,string[] captions)
            {
                if (mImageListView != null)
                    mImageListView.mRenderer.SuspendPaint();
