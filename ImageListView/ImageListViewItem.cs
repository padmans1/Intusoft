...
namespace INTUSOFT.ImageListView
{
    ...
    public class ImageListViewItem
    {
        ...
        /// </summary>
        /// <param name="filename">The image filename representing the item.</param>
        public ImageListViewItem(string filename,string Caption = "")
            : this()
        {
            mFileName = filename;
            mText = Caption;
        ...
        /// </summary>
        /// <param name="filename">The image filename representing the item.</param>
        public ImageListViewItem(string filename, string toolTip, string Caption = "")
            : this()
        {
            mFileName = filename;
            mText = Caption;
        ...
        internal void UpdateDetailsInternal(Utility.ShellImageFileInfo info)
        {
            ...
            mResolution = new SizeF(30.0F,30.0F);
            // Exif tags
