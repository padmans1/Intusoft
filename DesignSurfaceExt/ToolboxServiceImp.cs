...
namespace DesignSurfaceExt {
    ...
    public class ToolboxServiceImp : IToolboxService {
       ...
       // public ToolStrip ToolBox { get; set; }
        ...
        void IToolboxService.AddToolboxItem( ToolboxItem toolboxItem ) {
            Toolbox.AddItem(toolboxItem,0,new ToolBoxLib.ToolBoxItemDetails());
            //Toolbox.Items.Add((ToolboxItem)toolboxItem);
        }
        ...
        ToolboxItemCollection IToolboxService.GetToolboxItems() {
            ...
            //ToolboxItem[] arr = new ToolboxItem[Toolbox.GetCount()];
            //Toolbox.Items.CopyTo(arr, 0);
            //Toolbox.Items.CopyTo(arr, 0);
            ToolboxItem[] arr = Toolbox.GetItems().ToArray();
