...
//	Mat gtemp1,gtemp2 ;
//	cvtColor(g1, gtemp1, CV_BGR2GRAY);
//	Mat g2;
//	source2.convertTo(g2, CV_8U);
//	
//	gtemp1.convertTo(gtemp1, CV_64F);
//
//	cvtColor(g2, gtemp2, CV_BGR2GRAY);
//
//	gtemp2.convertTo(gtemp2, CV_64F);
//
//	for (int i=0;i<rows;++i){
//		for (int j=0;j<cols;++j){
//			double &a=*(((double *)(gtemp2.data))+i*cols+j);
//			double &b=*(((double *)(gtemp1.data))+i*cols+j);
//			
...
//
//		Mat lrsrGray ;//= cvCreateMat(source.rows,source.cols,CV_8UC1);
...
////	int gif=0;
////	
////	//Mat img=imread("D:\\Projects\\colorCorrection\\colorCorrection\\bin\\x64\\Debug\\processed.png", CV_LOAD_IMAGE_ANYDEPTH|CV_LOAD_IMAGE_ANYCOLOR);
////	IplImage* inp = cvLoadImage("D:\\Projects\\colorCorrection\\colorCorrection\\bin\\x64\\Debug\\processed.png",CV_LOAD_IMAGE_ANYDEPTH|CV_LOAD_IMAGE_ANYCOLOR);
...
////		sscanf_s(argv[3], "%d", &n);
////		if (argc>4){
////			sscanf_s(argv[4], "%lf", &a);
////			if (argc>5){
////				sscanf_s(argv[5], "%d", &brightnessAdjustment);
////				if (argc>6){
////					sscanf_s(argv[6], "%d", &colorCorrection);
////					if (argc>7){
////						sscanf_s(argv[7], "%d", &gif);
////					}
////				}
////			}
////		}
...
////	//imwrite("D:\\Projects\\colorCorrection\\colorCorrection\\bin\\x64\\Debug\\processed_ColotCorrected.png", result);
////	inp =cvCloneImage(&(IplImage)result);
////	cvSaveImage("processed_ColorCorrected.png",inp);
////	printf("Done");
////	return 0;
////}
//
//extern "C"__declspec(dllexport) void ColorCorrection(IplImage * inp,int n,double a,int brightnessAdjust,int colorCorretion,int guidedFilter)
//{
//	/* n=4;
//	 a=0.55;
//	 brightnessAdjust=1;
...
//	
//	Mat result;
//	Adjust(img, result, brightnessAdjust, colorCorretion, n, false, guidedFilter, a);
//	result.convertTo(result, CV_8U);
//IplImage* dest1 = cvCloneImage(&(IplImage)result);
//cvCopy(dest1,inp);
